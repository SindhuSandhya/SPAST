...
import { CandidateList, JobApplydata, JobGriddata, JobListdata, cartData, chatData, chatMessagesData, customersData, emailData, listData, orders, ordersData, projectData, recentFiles, tasks, userGridData, userList } from '../data';
